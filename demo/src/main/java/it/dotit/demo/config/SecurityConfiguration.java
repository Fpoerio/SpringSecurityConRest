...
public class SecurityConfiguration {
        ...
        private final AuthenticationProvider authenticationProvider; // Componente per la gestione dell'autenticazione
                                                                     // dell'utente
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                ...
                http
                                ...
                                .authorizeHttpRequests(auth -> auth // Configura l'autorizzazione per le richieste HTTP
                                                .requestMatchers("/nonAutenticato/**",
                                                        "/v2/api-docs",
                                                        "/v3/api-docs",
                                                        "/v3/api-docs/**",
                                                        "/swagger-resources",
                                                        ...
                                                        "swagger-ui/**",
                                                        "webjars/**",
                                                        "/swagger-ui.html").permitAll() // Consente l'accesso
                                                                                                   // non autenticato a
                                                                                                   // questo percorso
                                                .anyRequest().authenticated() // Richiede autenticazione per tutte le
                                                                              // altre richieste
                                )
                                .sessionManagement(sess -> sess
                                                .sessionCreationPolicy(SessionCreationPolicy.STATELESS) // Imposta la
                                                                                                        // gestione
                                                                                                        // delle
                                                                                                        // sessioni
                                                                                                        // come
                                ...
                                .authenticationProvider(authenticationProvider) // Imposta il provider di autenticazione
                                                                                // da utilizzare
                                .addFilterBefore(jwtAuthFilter, UsernamePasswordAuthenticationFilter.class); // Aggiunge
                                                                                                             // il
                                                                                                             // filtro
                                                                                                             // JWT
                                                                                                             // prima
                ...
                http.logout(logout -> logout
                                ...
                                .addLogoutHandler(logoutHandler) // Aggiunge un gestore per gestire le operazioni di
                                                                 // logout
                                .logoutSuccessHandler((request, response, authentication) -> SecurityContextHolder
                                                .clearContext()) // Pulisce
                                                                 // il
                                                                 // contesto
                                                                 // di
                                                                 // sicurezza
